...
构建 / 审查文言题库时，可调用以下词表作为权威词目与义项基线：

- `references/文言词表/江西省中考文言文高频词表.md`：中考高频文言实词表。
- `references/文言词表/000中学文言文常用词常用义-合集.md`：常用词常用义汇编。
- `references/文言词表/词条标准模板.md`：词条录入标准模板（保证 id / 字形 / 义项字段一致）。
- `references/文言词表/文言文高频词义项整理_第3组.md`、`江西省中考真题文言文高频词义项整理_第2组.md`、`教材与江西中考文言文字频统计报告.md`：高频词义项与字频依据。

> 题库词目、字形、义项须与这些基线一致；新增词目请套用 `词条标准模板`。
